...
// from TTree DelilaPreSorting/Energy Station
// found on file: run1005_03.root
//////////////////////////////////////////////////////////

#pragma once

#ifndef DelilaPreSorting_h
#define DelilaPreSorting_h
...
class DelilaPreSorting : public TSelector {
public :
...
//   ULong64_t nevents_reset;
  ...
  TObjArray *toks;
   ...
   DelilaPreSorting(TTree * /*tree*/ =0) { }
   virtual ~DelilaPreSorting() { }
...
//    virtual void TimeAlignementTrigger();
   ...
   ClassDef(DelilaPreSorting,0);
   
};

#endif

#ifdef DelilaPreSorting_cxx
void DelilaPreSorting::Init(TTree *tree)
{
...
Bool_t DelilaPreSorting::Notify()
{
...
#endif // #ifdef DelilaPreSorting_cxx
